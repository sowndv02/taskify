    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-01', 'card-id-05', 'card-id-04', 'card-id-03', 'card-id-02', 'card-id-06', 'card-id-07'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
      ...
      },
      {
        _id: 'column-id-04',
        boardId: 'board-id-01',
        title: 'Empty Column 01',
        // Each column contains 0 or 1 Placeholder Card
